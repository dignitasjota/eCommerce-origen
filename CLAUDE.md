...
Documento de referencia del proyecto. Estado actualizado al **2026-09-10**, tras los Sprints 1–5, tareas continuas, dockerización, operativa, compliance, escala UI, pre-producción, CI/CD, drag&drop de imágenes, editor WYSIWYG (Tiptap), una **auditoría de seguridad en profundidad con corrección + validación real de todos los hallazgos** (ver §9.9) y **10 de los 14 ítems del backlog premium** (reseñas con foto, stock countdown, wishlist compartible, comparador, WhatsApp, RBAC fino + auditoría completa, PWA, fidelización, matriz combinatoria de variantes, A/B testing del hero — detalle completo en [`ROADMAP.md`](./ROADMAP.md), no duplicado aquí). Roadmap ejecutivo en [`ROADMAP.md`](./ROADMAP.md).
...
### Entidades del backlog premium (2026-09-10, ver `ROADMAP.md`)
...
| Backlog premium | 2026-09-10 | 10/14 ítems, cada uno validado individualmente contra Node 22 + MariaDB Docker + build + suite e2e | Reseñas con foto + verificación (y moderación admin nueva, antes inexistente) · stock countdown/urgencia · wishlist compartible · comparador de productos · WhatsApp Business · RBAC fino (`User.permissions`) + auditoría completa · PWA (manifest + service worker) · programa de fidelización (`LoyaltyTransaction`) · matriz combinatoria de variantes (arregló selección de variantes rota desde el origen — `ProductVariantOption` nunca se escribía) · A/B testing del hero (`AbTestEvent`). Los 4 restantes (multi-warehouse, marketplace multi-vendor, multi-tienda, Veri*Factu) son cambios de arquitectura/modelo de negocio o requieren integración de pago externa — detalle completo en [`ROADMAP.md`](./ROADMAP.md), no duplicado aquí. |
